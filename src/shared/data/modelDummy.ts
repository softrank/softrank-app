...
export const CapacitiesDummy: Capacity[] = [
  {
    id: '',
    name: 'O processo produz os resultados definidos',
    type: 'P',
    maxLevel: LevelOptions[0],
    minLevel: LevelOptions[6],
  },
  {
    id: '',
    name: 'A execução do processo é planejada e monitorada',
    type: 'P',
    maxLevel: LevelOptions[5],
    minLevel: LevelOptions[6],
  },
  {
    id: '',
    name: 'As pessoas estão preparadas para executar suas responsabilidades no processo',
    type: 'P',
    maxLevel: LevelOptions[0],
    minLevel: LevelOptions[6],
  },
  {
    id: '',
    name: 'A verificação objetiva de que o processo é seguido é realizada',
    type: 'P',
    maxLevel: LevelOptions[0],
    minLevel: LevelOptions[5],
  },
  {
    id: '',
    name: 'Os produtos de trabalho selecionados são avaliados objetivamente ao longo do projeto em relação ao processo e padrões aplicáveis, os resultados são registrados, comunicados e a resolução de não conformidades é assegurada',
    type: 'P',
    maxLevel: LevelOptions[0],
    minLevel: LevelOptions[5],
  },
  {
    id: '',
    name: 'O processo padrão e as diretrizes para adaptação são usados para planejar, executar e monitorar o trabalho. O planejamento inclui identificação de papéis, responsabilidades, cronograma, recursos e infraestrutura',
    type: 'P',
    maxLevel: LevelOptions[0],
    minLevel: LevelOptions[4],
  },
  {
    id: '',
    name: 'Oportunidades de melhoria no processo são identificadas durante as atividades de garantia da qualidade',
    type: 'P',
    maxLevel: LevelOptions[1],
    minLevel: LevelOptions[4],
  },
  {
    id: '',
    name: 'Informações relacionadas ao processo ou ativos de processo são disponibilizadas para a organização',
    type: 'P',
    maxLevel: LevelOptions[0],
    minLevel: LevelOptions[4],
  },
  {
    id: '',
    name: 'Técnicas estatísticas e outras técnicas quantitativas são utilizadas para determinar ou prever o alcance de objetivos de qualidade e de desempenho dos processos',
    type: 'P',
    maxLevel: LevelOptions[0],
    minLevel: LevelOptions[1],
  },
  {
    id: '',
    name: 'Oportunidades de melhoria no processo são identificadas durante as atividades de garantia da qualidade e a partir de resultados efetivos provenientes de análise de causa-raiz',
    type: 'P',
    maxLevel: LevelOptions[0],
    minLevel: LevelOptions[0],
  },
  {
    id: '',
    name: 'Propostas de melhoria são selecionadas e implementadas, com base em análise estatística e quantitativa realizada sobre os efeitos esperados das propostas de melhoria para o alcance dos objetivos de negócio, qualidade e desempenho do processo',
    type: 'P',
    maxLevel: LevelOptions[0],
    minLevel: LevelOptions[0],
  },
...
export const modelDummy: ModelEntity = {
  ...
  modelCapacities: CapacitiesDummy,
};
